// src/lib.rs
/*
 * Core library for AudioWorkshop
 */
...
#[derive(Debug)]
pub struct AudioWorkshopProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AudioWorkshopProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AudioWorkshop processing");
    
    let mut processor = AudioWorkshopProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AudioWorkshopProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AudioWorkshopProcessor::new(false);
